# Accessibility (a11y) Skill - Detailed Guide
...
- [wcag-checklist.md](wcag-checklist.md) - Full WCAG 2.1 AA checklist
- [testing-tools.md](testing-tools.md) - Tool configuration guides
- [common-fixes.md](common-fixes.md) - Code fixes for common issues
