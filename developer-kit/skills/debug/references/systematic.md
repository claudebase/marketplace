# Systematic Debugging Methodology (Tier 2)
...
Use for ANY technical issue where Tier 1 (quick fix) isn't sufficient:
...
#### 1.5 Root Cause Tracing (Backward Through Call Stack)
...
4. **If Fix Doesn't Work**
   ...
   - **If >= 3: Escalate to Tier 3 (Deep RCA)**
   - DON'T attempt Fix #4 without escalation

5. **If 3+ Fixes Failed: Escalate**

   **Pattern indicating need for Tier 3:**
   - Each fix reveals new shared state/coupling/problem in different place
   - Fixes require "massive refactoring" to implement
   - Each fix creates new symptoms elsewhere

   **This is NOT a failed hypothesis - this may be a wrong architecture.**
...
|-------|---------------|------------------|
| **1. Root Cause** | Read errors, reproduce, check changes, trace backward | Understand WHAT and WHY |
