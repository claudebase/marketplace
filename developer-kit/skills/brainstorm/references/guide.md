# Brainstorm Skill - Detailed Guide
...
- [question-patterns.md](question-patterns.md) - Socratic question library
- [exploration-framework.md](exploration-framework.md) - Systematic exploration guide
